 ...
 * l'application est en fait un module qui va appeler d'autre modules (en 2eme paramètre : todolist)
 * il pourra y avoir par la suite plusieurs modules appelés par le module principal (l'application)
 */
